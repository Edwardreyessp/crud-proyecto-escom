...
const Nivel5 = ({crud, setStar5,Star5,Inicio,challengesN5, setBandera5}) => {
  ...
  return (
    <div>
      {challengesN5===0 ? <h1>The task are empty</h1>
      :<>
      {superado === challengesN5 
        ? <Felicidades setBandera5={setBandera5} id={crud[crudPosition - 1].id}/>
        : <>
            <h1>Let's Play</h1>
            ...
            {(answer1 && answer2 && answer3 && song) && setStar5(Star5+1 ) }
