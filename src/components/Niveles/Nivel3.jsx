...
const Nivel3 = ({crud, setStar3,Star3,Inicio,challengesN3, setBandera3}) => {
  ...
  return (
    <div>
      {challengesN3===0 ? <h1>The task are empty</h1>
      :<>
      {superado === challengesN3 
        ? <Felicidades setBandera3={setBandera3} id={crud[crudPosition - 1].id}/>
        : <>
            <h1>Let's Play</h1>
            ...
            {(answer1 && answer2 && answer3 && song) && setStar3(Star3+1 ) }
