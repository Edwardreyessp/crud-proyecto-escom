...
const Nivel2 = ({crud, setStar2,Star2,Inicio,challengesN2, setBandera2}) => {
  ...
  return (
    <div>
      {challengesN2===0 ? <h1>The task are empty</h1>
      :<>
      {superado === challengesN2 
        ? <Felicidades setBandera2={setBandera2} id={crud[crudPosition - 1].id}/>
        : <>
            <h1>Let's Play</h1>
            ...
            {(answer1 && answer2 && answer3 && song) && setStar2(Star2+1 ) }
