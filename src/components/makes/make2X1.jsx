...
const Make2X1 = () => {
    ...
    return (
        <div>
            ...
            />
            <h3>Icognita1</h3>
            <select name={incognita1}>
            <option value="x1">X1</option>
            <option value="x2" selected>X2</option>
            <option value="y1">Y1</option>
            <option value="ytotal">Ytotal</option>
            <option value="xtotal">Xtotal</option>
            <option value="x1pory1">X1porY1</option>
            <option value="x2pory1">X2porY1</option>
